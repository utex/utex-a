...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Utex " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"utextools.com", "dnsseed.utextools.com"},
    {"utexpool.org", "dnsseed.utexpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"utextools.com", "testnet-seed.utextools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Utex is probably already running."), addrBind.ToString().c_str());
        else
